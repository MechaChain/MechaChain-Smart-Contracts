 ...
 */
contract MechaLandsV2 is MechaLandsV1 {
     ...
     */
    function setRoundPaymentType(uint256 roundId, uint256 paymentType)
        public
        onlyOwner
    {
     ...
     */
    function withdrawMechaniumToken(address to, uint256 amount)
        public
        onlyOwner
    {
