...
/**
 * @dev Mechanim can release unintented ( ownable ) smart contract interface
 * @author EthernalHorizons - <https://ethernalhorizons.com/>
 * @custom:project-website  https://mechachain.io/
 * @custom:security-contact contracts@ethernalhorizons.com
 */
interface IMechaniumCanReleaseUnintentedOwnable {
    /**
     * @dev Release unintented tokens sent to smart contract ( only owner )
