...
**Documentation of `MechaniumVesting/MechaniumFoundersDistribution.sol`.**
...
### `Withdraw(address caller, uint256 amount)`  <a name="MechaniumFoundersDistribution-Withdraw-address-uint256-" id="MechaniumFoundersDistribution-Withdraw-address-uint256-"></a>
...
### `WithdrawLocked(address caller)`  <a name="MechaniumFoundersDistribution-WithdrawLocked-address-" id="MechaniumFoundersDistribution-WithdrawLocked-address-"></a>
...
### `constructor(contract IERC20 token_)` (public) <a name="MechaniumFoundersDistribution-constructor-contract-IERC20-" id="MechaniumFoundersDistribution-constructor-contract-IERC20-"></a>
...
### `lockWithdraw() → bool` (external) <a name="MechaniumFoundersDistribution-lockWithdraw--" id="MechaniumFoundersDistribution-lockWithdraw--"></a>
...
### `withdraw() → bool` (external) <a name="MechaniumFoundersDistribution-withdraw--" id="MechaniumFoundersDistribution-withdraw--"></a>
...
### `isWithdrawLocked() → bool` (external) <a name="MechaniumFoundersDistribution-isWithdrawLocked--" id="MechaniumFoundersDistribution-isWithdrawLocked--"></a>
