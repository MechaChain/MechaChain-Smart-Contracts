...
**Documentation of `MechaniumVesting/MechaniumAirdropDistribution.sol`.**

MechaniumAirdropDistribution - Airdrop distribution smart contract
...
## TABLE OF CONTENTS
- [Events](#events)
    - [`VestingStartingTimeChanged`](#MechaniumAirdropDistribution-VestingStartingTimeChanged-uint256-) 
    - [`TransferUnsoldToPTEPool`](#MechaniumAirdropDistribution-TransferUnsoldToPTEPool-uint256-) 
    - [`TransferToStakingPool`](#MechaniumAirdropDistribution-TransferToStakingPool-address-uint256-uint256-) 
...
- [Public Functions](#public-functions)
    - [`constructor`](#MechaniumAirdropDistribution-constructor-contract-IERC20-) 
    - [`allocateTokens`](#MechaniumAirdropDistribution-allocateTokens-address-uint256-) 
    - [`allocateMultipleTokens`](#MechaniumAirdropDistribution-allocateMultipleTokens-address---uint256---) 
    - [`startVesting`](#MechaniumAirdropDistribution-startVesting--) 
    - [`startVesting`](#MechaniumAirdropDistribution-startVesting-uint256-) 
    - [`setStakingPool`](#MechaniumAirdropDistribution-setStakingPool-address-) 
    - [`setStakingTransferTimeLimit`](#MechaniumAirdropDistribution-setStakingTransferTimeLimit-uint256-) 
    - [`setMinimumStakingTime`](#MechaniumAirdropDistribution-setMinimumStakingTime-uint256-) 
    - [`transferToStakingPool`](#MechaniumAirdropDistribution-transferToStakingPool-uint256-uint256-) 
    - [`allocatedTokensOf`](#MechaniumAirdropDistribution-allocatedTokensOf-address-) 
    - [`pendingTokensOf`](#MechaniumAirdropDistribution-pendingTokensOf-address-) 
    - [`unlockableTokens`](#MechaniumAirdropDistribution-unlockableTokens-address-) 
    - [`hasVestingStarted`](#MechaniumAirdropDistribution-hasVestingStarted--) 
    - [`vestingStartingTime`](#MechaniumAirdropDistribution-vestingStartingTime--) 
    - [`maxVestingStartingTime`](#MechaniumAirdropDistribution-maxVestingStartingTime--) 
    - [`getStakingPoolAddress`](#MechaniumAirdropDistribution-getStakingPoolAddress--) 
    - [`getStrakingTransferTimeLimit`](#MechaniumAirdropDistribution-getStrakingTransferTimeLimit--) 
    - [`getMinimumStakingTime`](#MechaniumAirdropDistribution-getMinimumStakingTime--) 
...
- [Modifiers](#modifiers)
    - [`vestingStarted`](#MechaniumAirdropDistribution-vestingStarted--) 
    - [`vestingNotStarted`](#MechaniumAirdropDistribution-vestingNotStarted--) 
...
### `VestingStartingTimeChanged(uint256 vestingStartingTime)`  <a name="MechaniumAirdropDistribution-VestingStartingTimeChanged-uint256-" id="MechaniumAirdropDistribution-VestingStartingTimeChanged-uint256-"></a>
...
### `TransferUnsoldToPTEPool(uint256 amount)`  <a name="MechaniumAirdropDistribution-TransferUnsoldToPTEPool-uint256-" id="MechaniumAirdropDistribution-TransferUnsoldToPTEPool-uint256-"></a>
...
### `TransferToStakingPool(address account, uint256 amount, uint256 stakingTime)`  <a name="MechaniumAirdropDistribution-TransferToStakingPool-address-uint256-uint256-" id="MechaniumAirdropDistribution-TransferToStakingPool-address-uint256-uint256-"></a>
...
### `constructor(contract IERC20 token_)` (public) <a name="MechaniumAirdropDistribution-constructor-contract-IERC20-" id="MechaniumAirdropDistribution-constructor-contract-IERC20-"></a>
...
### `allocateTokens(address to, uint256 amount) → bool` (public) <a name="MechaniumAirdropDistribution-allocateTokens-address-uint256-" id="MechaniumAirdropDistribution-allocateTokens-address-uint256-"></a>
...
### `allocateMultipleTokens(address[] addresses, uint256[] amounts) → bool` (public) <a name="MechaniumAirdropDistribution-allocateMultipleTokens-address---uint256---" id="MechaniumAirdropDistribution-allocateMultipleTokens-address---uint256---"></a>
...
### `startVesting() → bool` (public) <a name="MechaniumAirdropDistribution-startVesting--" id="MechaniumAirdropDistribution-startVesting--"></a>
...
### `startVesting(uint256 startTime) → bool` (public) <a name="MechaniumAirdropDistribution-startVesting-uint256-" id="MechaniumAirdropDistribution-startVesting-uint256-"></a>
...
### `setStakingPool(address stakingPoolAddress) → bool` (public) <a name="MechaniumAirdropDistribution-setStakingPool-address-" id="MechaniumAirdropDistribution-setStakingPool-address-"></a>
...
### `setStakingTransferTimeLimit(uint256 stakingTransferTimeLimit) → bool` (public) <a name="MechaniumAirdropDistribution-setStakingTransferTimeLimit-uint256-" id="MechaniumAirdropDistribution-setStakingTransferTimeLimit-uint256-"></a>
...
### `setMinimumStakingTime(uint256 minimumStakingTime) → bool` (public) <a name="MechaniumAirdropDistribution-setMinimumStakingTime-uint256-" id="MechaniumAirdropDistribution-setMinimumStakingTime-uint256-"></a>
...
### `transferToStakingPool(uint256 amount, uint256 stakingTime) → bool` (public) <a name="MechaniumAirdropDistribution-transferToStakingPool-uint256-uint256-" id="MechaniumAirdropDistribution-transferToStakingPool-uint256-uint256-"></a>
...
### `allocatedTokensOf(address account) → uint256` (public) <a name="MechaniumAirdropDistribution-allocatedTokensOf-address-" id="MechaniumAirdropDistribution-allocatedTokensOf-address-"></a>
...
### `pendingTokensOf(address account) → uint256` (public) <a name="MechaniumAirdropDistribution-pendingTokensOf-address-" id="MechaniumAirdropDistribution-pendingTokensOf-address-"></a>
...
### `unlockableTokens(address account) → uint256` (public) <a name="MechaniumAirdropDistribution-unlockableTokens-address-" id="MechaniumAirdropDistribution-unlockableTokens-address-"></a>
...
### `hasVestingStarted() → bool` (public) <a name="MechaniumAirdropDistribution-hasVestingStarted--" id="MechaniumAirdropDistribution-hasVestingStarted--"></a>
...
### `vestingStartingTime() → uint256` (public) <a name="MechaniumAirdropDistribution-vestingStartingTime--" id="MechaniumAirdropDistribution-vestingStartingTime--"></a>
...
### `maxVestingStartingTime() → uint256` (public) <a name="MechaniumAirdropDistribution-maxVestingStartingTime--" id="MechaniumAirdropDistribution-maxVestingStartingTime--"></a>
...
### `getStakingPoolAddress() → address` (public) <a name="MechaniumAirdropDistribution-getStakingPoolAddress--" id="MechaniumAirdropDistribution-getStakingPoolAddress--"></a>
...
### `getStrakingTransferTimeLimit() → uint256` (public) <a name="MechaniumAirdropDistribution-getStrakingTransferTimeLimit--" id="MechaniumAirdropDistribution-getStrakingTransferTimeLimit--"></a>
...
### `getMinimumStakingTime() → uint256` (public) <a name="MechaniumAirdropDistribution-getMinimumStakingTime--" id="MechaniumAirdropDistribution-getMinimumStakingTime--"></a>
...
### `vestingStarted()`  <a name="MechaniumAirdropDistribution-vestingStarted--" id="MechaniumAirdropDistribution-vestingStarted--"></a>
...
### `vestingNotStarted()`  <a name="MechaniumAirdropDistribution-vestingNotStarted--" id="MechaniumAirdropDistribution-vestingNotStarted--"></a>
