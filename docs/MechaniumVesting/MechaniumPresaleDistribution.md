...
**Documentation of `MechaniumVesting/MechaniumPresaleDistribution.sol`.**
...
### `VestingStartingTimeChanged(uint256 vestingStartingTime)`  <a name="MechaniumPresaleDistribution-VestingStartingTimeChanged-uint256-" id="MechaniumPresaleDistribution-VestingStartingTimeChanged-uint256-"></a>
Event emitted when the `vestingStartingTime` has changed




### `TransferUnsoldToPTEPool(uint256 amount)`  <a name="MechaniumPresaleDistribution-TransferUnsoldToPTEPool-uint256-" id="MechaniumPresaleDistribution-TransferUnsoldToPTEPool-uint256-"></a>
Event emitted when `amount` tokens has been transferred to the play to earn pool




### `TransferToStakingPool(address account, uint256 amount, uint256 stakingTime)`  <a name="MechaniumPresaleDistribution-TransferToStakingPool-address-uint256-uint256-" id="MechaniumPresaleDistribution-TransferToStakingPool-address-uint256-uint256-"></a>
...
### `constructor(contract IERC20 token_)` (public) <a name="MechaniumPresaleDistribution-constructor-contract-IERC20-" id="MechaniumPresaleDistribution-constructor-contract-IERC20-"></a>
...
### `allocateTokens(address to, uint256 amount) → bool` (public) <a name="MechaniumPresaleDistribution-allocateTokens-address-uint256-" id="MechaniumPresaleDistribution-allocateTokens-address-uint256-"></a>
...
### `startVesting() → bool` (public) <a name="MechaniumPresaleDistribution-startVesting--" id="MechaniumPresaleDistribution-startVesting--"></a>
Start the vesting immediately




### `startVesting(uint256 startTime) → bool` (public) <a name="MechaniumPresaleDistribution-startVesting-uint256-" id="MechaniumPresaleDistribution-startVesting-uint256-"></a>
...
### `setStakingPool(address stakingPoolAddress) → bool` (public) <a name="MechaniumPresaleDistribution-setStakingPool-address-" id="MechaniumPresaleDistribution-setStakingPool-address-"></a>
...
### `setStakingTransferTimeLimit(uint256 stakingTransferTimeLimit) → bool` (public) <a name="MechaniumPresaleDistribution-setStakingTransferTimeLimit-uint256-" id="MechaniumPresaleDistribution-setStakingTransferTimeLimit-uint256-"></a>
...
### `setMinimumStakingTime(uint256 minimumStakingTime) → bool` (public) <a name="MechaniumPresaleDistribution-setMinimumStakingTime-uint256-" id="MechaniumPresaleDistribution-setMinimumStakingTime-uint256-"></a>
...
### `transferToStakingPool(uint256 amount, uint256 stakingTime) → bool` (public) <a name="MechaniumPresaleDistribution-transferToStakingPool-uint256-uint256-" id="MechaniumPresaleDistribution-transferToStakingPool-uint256-uint256-"></a>
Transfer tokens balance ( allocated but not claimed ) to the staking pool




### `allocatedTokensOf(address account) → uint256` (public) <a name="MechaniumPresaleDistribution-allocatedTokensOf-address-" id="MechaniumPresaleDistribution-allocatedTokensOf-address-"></a>

Return the amount of allocated tokens for `account` from the beginning



### `pendingTokensOf(address account) → uint256` (public) <a name="MechaniumPresaleDistribution-pendingTokensOf-address-" id="MechaniumPresaleDistribution-pendingTokensOf-address-"></a>

Return the amount of tokens that the `account` can unlock in real time



### `unlockableTokens(address account) → uint256` (public) <a name="MechaniumPresaleDistribution-unlockableTokens-address-" id="MechaniumPresaleDistribution-unlockableTokens-address-"></a>

Return the amount of tokens that the `account` can unlock per month



### `hasVestingStarted() → bool` (public) <a name="MechaniumPresaleDistribution-hasVestingStarted--" id="MechaniumPresaleDistribution-hasVestingStarted--"></a>

Return true if the vesting schedule has started



### `vestingStartingTime() → uint256` (public) <a name="MechaniumPresaleDistribution-vestingStartingTime--" id="MechaniumPresaleDistribution-vestingStartingTime--"></a>

Return the starting time of the vesting schedule



### `maxVestingStartingTime() → uint256` (public) <a name="MechaniumPresaleDistribution-maxVestingStartingTime--" id="MechaniumPresaleDistribution-maxVestingStartingTime--"></a>

Return the unchangeable maximum vesting starting time



### `getStakingPoolAddress() → address` (public) <a name="MechaniumPresaleDistribution-getStakingPoolAddress--" id="MechaniumPresaleDistribution-getStakingPoolAddress--"></a>

Return the staking pool address



### `getStrakingTransferTimeLimit() → uint256` (public) <a name="MechaniumPresaleDistribution-getStrakingTransferTimeLimit--" id="MechaniumPresaleDistribution-getStrakingTransferTimeLimit--"></a>

Return the staking transfer time limit



### `getMinimumStakingTime() → uint256` (public) <a name="MechaniumPresaleDistribution-getMinimumStakingTime--" id="MechaniumPresaleDistribution-getMinimumStakingTime--"></a>
...
### `vestingStarted()`  <a name="MechaniumPresaleDistribution-vestingStarted--" id="MechaniumPresaleDistribution-vestingStarted--"></a>
...
### `vestingNotStarted()`  <a name="MechaniumPresaleDistribution-vestingNotStarted--" id="MechaniumPresaleDistribution-vestingNotStarted--"></a>
