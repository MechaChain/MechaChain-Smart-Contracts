# `MechaniumAdvisorsDistribution`
**Documentation of `MechaniumVesting/MechaniumAdvisorsDistribution.sol`.**
...
### `constructor(contract IERC20 token_)` (public) <a name="MechaniumAdvisorsDistribution-constructor-contract-IERC20-" id="MechaniumAdvisorsDistribution-constructor-contract-IERC20-"></a>
