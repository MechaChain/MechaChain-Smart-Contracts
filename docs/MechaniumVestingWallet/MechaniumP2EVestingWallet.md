# `MechaniumP2EVestingWallet`
**Documentation of `MechaniumVestingWallet/MechaniumP2EVestingWallet.sol`.**

MechaniumGrowthVestingWallet - Hold $MECHA allocated to the P2E pool with a vesting schedule
...
## TABLE OF CONTENTS
- [Events](#events)
    - [`TransferredTokens`](#MechaniumVestingWallet-TransferredTokens-address-address-uint256-) (inherited)
    - [`SoldOut`](#MechaniumVestingWallet-SoldOut-uint256-) (inherited)
...
- [Public Functions](#public-functions)
    - [`constructor`](#MechaniumP2EVestingWallet-constructor-contract-IERC20-) 
    - [`transfer`](#MechaniumVestingWallet-transfer-address-uint256-) (inherited)
    - [`unlockableTokens`](#MechaniumVestingWallet-unlockableTokens--) (inherited)
    - [`token`](#MechaniumVestingWallet-token--) (inherited)
    - [`tokenBalance`](#MechaniumVestingWallet-tokenBalance--) (inherited)
    - [`totalSupply`](#MechaniumVestingWallet-totalSupply--) (inherited)
    - [`totalReleasedTokens`](#MechaniumVestingWallet-totalReleasedTokens--) (inherited)
    - [`vestingPerClock`](#MechaniumVestingWallet-vestingPerClock--) (inherited)
    - [`vestingClockTime`](#MechaniumVestingWallet-vestingClockTime--) (inherited)
    - [`initialVesting`](#MechaniumVestingWallet-initialVesting--) (inherited)
    - [`startTime`](#MechaniumVestingWallet-startTime--) (inherited)
...
### `TransferredTokens(address caller, address to, uint256 amount)` (inherited) <a name="MechaniumVestingWallet-TransferredTokens-address-address-uint256-" id="MechaniumVestingWallet-TransferredTokens-address-address-uint256-"></a>
Event emitted when `caller` transferred `amount` unlock tokens for `to` address



_Inherited from `MechaniumVestingWallet/MechaniumVestingWallet.sol`_.


### `SoldOut(uint256 totalAllocated)` (inherited) <a name="MechaniumVestingWallet-SoldOut-uint256-" id="MechaniumVestingWallet-SoldOut-uint256-"></a>
...
### `constructor(contract IERC20 token_)` (public) <a name="MechaniumP2EVestingWallet-constructor-contract-IERC20-" id="MechaniumP2EVestingWallet-constructor-contract-IERC20-"></a>
...
### `transfer(address to, uint256 amount) → bool` (public) (inherited)<a name="MechaniumVestingWallet-transfer-address-uint256-" id="MechaniumVestingWallet-transfer-address-uint256-"></a>
...
### `unlockableTokens() → uint256` (public) (inherited)<a name="MechaniumVestingWallet-unlockableTokens--" id="MechaniumVestingWallet-unlockableTokens--"></a>
...
### `token() → address` (public) (inherited)<a name="MechaniumVestingWallet-token--" id="MechaniumVestingWallet-token--"></a>
...
### `tokenBalance() → uint256` (public) (inherited)<a name="MechaniumVestingWallet-tokenBalance--" id="MechaniumVestingWallet-tokenBalance--"></a>
...
### `totalSupply() → uint256` (public) (inherited)<a name="MechaniumVestingWallet-totalSupply--" id="MechaniumVestingWallet-totalSupply--"></a>
...
### `totalReleasedTokens() → uint256` (public) (inherited)<a name="MechaniumVestingWallet-totalReleasedTokens--" id="MechaniumVestingWallet-totalReleasedTokens--"></a>
...
### `vestingPerClock() → uint256` (public) (inherited)<a name="MechaniumVestingWallet-vestingPerClock--" id="MechaniumVestingWallet-vestingPerClock--"></a>
...
### `vestingClockTime() → uint256` (public) (inherited)<a name="MechaniumVestingWallet-vestingClockTime--" id="MechaniumVestingWallet-vestingClockTime--"></a>
...
### `initialVesting() → uint256` (public) (inherited)<a name="MechaniumVestingWallet-initialVesting--" id="MechaniumVestingWallet-initialVesting--"></a>
...
### `startTime() → uint256` (public) (inherited)<a name="MechaniumVestingWallet-startTime--" id="MechaniumVestingWallet-startTime--"></a>
