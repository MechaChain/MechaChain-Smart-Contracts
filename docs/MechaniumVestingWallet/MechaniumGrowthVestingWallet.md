...
**Documentation of `MechaniumVestingWallet/MechaniumGrowthVestingWallet.sol`.**
...
### `constructor(contract IERC20 token_)` (public) <a name="MechaniumGrowthVestingWallet-constructor-contract-IERC20-" id="MechaniumGrowthVestingWallet-constructor-contract-IERC20-"></a>
